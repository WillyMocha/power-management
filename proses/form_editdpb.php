...
$query = "SELECT  id_device_pb, nama, daya, jumlah, jam, prioritas, total_daya, nilai from device_pb where id_device_pb='$id_device_pb'"; 
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <form method="post" name="editdata_devicepb" action="editdata_devicepb.php">
               <div class="row">
                 <div class="col-md-6">
                    <label class="control-label">ID Device</label>
                    <input type="text" class="form-control" name="id_device_pb" value="<?php echo $row['id_device_pb']; ?>" required>
                  </div>
                  <div class="col-md-6">
