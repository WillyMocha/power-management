...
$id_device_pb=$_GET['id_device_pb'];
$query = "SELECT * from device_pb where id_device_pb='$id_device_pb'"; 
...
{ 
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i> Tambah Device </h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <form method="post" name="tambahdata" action="tambahdata_devicepb.php">
               <div class="row">
                  <div class="col-md-6">
                    <label class="control-label">Nama Device</label>
                    <input type="text" class="form-control" placeholder="AC" name="nama" value="<?php echo $row['nama']; ?>" required>
                  </div>
                  <div class="col-md-6">
                    <label class="control-label">Daya (Watt)</label>
                    <input type="text" class="form-control" placeholder="430" name="daya" value="<?php echo $row['daya']; ?>" required>
                  </div>
                  <div class="col-md-6">
                    <label class="control-label">Jumlah</label>
                    <input type="text" class="form-control" placeholder="7" name="jumlah" value="<?php echo $row['jumlah']; ?>" required>
                  </div>
                  <div class="col-md-6">
                    <label class="form-group" for="jam">Jam : </label>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="1 - 10" name="prioritas" value="<?php echo $row['prioritas']; ?>" required>
                  </div>
                  <!-- <div class="col-md-6">
